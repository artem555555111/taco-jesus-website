...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      {/* Beautiful gradient background - keeping current one */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
        ...
        >
          ...
          <motion.h1
            ...
            className="font-lobster text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-white mb-3 sm:mb-4 relative px-4"
          >
            <span className="relative z-10">{t('hero.title')}</span>
            <div className="absolute inset-0 bg-gradient-to-r from-white/10 to-white/10 blur-3xl transform scale-110"></div>
          </motion.h1>
          ...
          >
            <p className="font-inter text-base sm:text-lg md:text-xl text-white font-bold relative leading-tight">
              <span className="relative z-10">{t('hero.subtitle')}</span>
              <div className="absolute inset-0 bg-gradient-to-r from-white/5 to-white/5 blur-xl transform scale-105"></div>
            </p>
          </motion.div>
          ...
          >
            <p className="font-inter text-sm sm:text-base md:text-lg text-white/90 font-medium relative leading-relaxed">
